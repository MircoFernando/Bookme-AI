...
## Corpus Check
- 58 files · ~23,740 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 572 nodes · 1066 edges · 23 communities (18 shown, 5 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 124 edges (avg confidence: 0.73)
...
8. `run_chat_turn()` - 15 edges
9. `build_decision_graph()` - 14 edges
10. `build_agent_mcp()` - 14 edges
...
Cohesion: 0.06
Nodes (36): AnyMessage, GuardrailVerdict, RunnableConfig, main(), _router_primary_route(), _run(), main(), map_decision_to_agent_state() (+28 more)
...
Cohesion: 0.08
Nodes (30): Exception, retry, _dumps(), _extract_hotels(), HotelTool, Any, Hotel tool — Convex hotel API (list / search / book).  Week 13 pattern: business, Hotel service actions routed by ``dispatch``. (+22 more)
